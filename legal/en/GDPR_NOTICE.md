...
- **France:** CNIL — cnil.fr
- **Germany:** BfDI — bfdi.bund.de (federal) + state DPAs
...
- We notify the competent Supervisory Authority within **72 hours** of becoming aware (Art. 33).
- We notify you directly without undue delay if the breach is likely to result in a **high risk** to your rights and freedoms (Art. 34) — via email and in-app notification.
